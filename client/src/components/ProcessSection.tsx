...
const steps = [
  {
    ...
    icon: MessageSquare,
    title: "Brief",
    description: "Nos cuentas tu visión, objetivos y referencias. Definimos el estilo y alcance del proyecto.",
    color: "#00E5A0",
  },
  {
    number: "02",
    icon: FileVideo,
    title: "Material",
    description: "Nos envías el material raw. Aceptamos cualquier formato de video, audio e imágenes.",
    color: "#22D3EE",
  },
  {
    number: "03",
    icon: Wand2,
    title: "Edición",
    description: "Nuestro equipo edita con precisión. Motion graphics, captions y color grading incluidos.",
    color: "#7C5CFC",
  },
  {
    number: "04",
